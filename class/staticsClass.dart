 ...
 */
void staticsClass() {
  final persona1 = Persona("Classe", "Statica", 5);
  final persona2 = Persona("Metodo", "Statica", 7);
  final diffEta = Persona.diffEta(persona1._age, persona2._age);
  print(persona1);
