...
void enumClass() {
  final persona1 = Persona.Boy("Pinci", "Limpi Dù", 10);
  print(persona1);
...
class Persona {
  ...
  Persona(this._name, this._surname, this._age, [this._gender = Genre.ND]);
  Persona.Boy(this._name, this._surname, this._age) : _gender = Genre.M;
  Persona.Girl(this._name, this._surname, this._age) : _gender = Genre.F;
